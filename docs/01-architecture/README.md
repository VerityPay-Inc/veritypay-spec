...
**Start here:** [DOMAIN_MODEL.md](DOMAIN_MODEL.md) — what VerityPay is (protocol), then the shared language (domain). Then [IDENTITY_MODEL.md](IDENTITY_MODEL.md) — what makes each object *itself* before fields and encodings.
