...
**Related documents:** `DATA_MODEL.md` (forthcoming), state models (forthcoming)
...
**Downstream:** `DATA_MODEL.md` (representations and storage identity), state models (mutable lifecycle)
